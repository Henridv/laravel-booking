  ...
  <div class="row justify-content-md-center">
    <div class="col-6">
      ...
      {{-- <div class="form-group">
        ...
        <select class="form-control" name="guest" id="customerSelect" @if(isset($booking)) data-customer-id="{{ $booking->customer_id }}" @endif>
          <option></option>
        </select>
      </div> --}}
      <div class="form-group">
        <label for="customerSelect">Hoofdboeker</label>
        <select class="form-control" name="guest" id="customerSelect" placeholder="Selecteer gast...">
          <option></option>
      ...
      <div class="form-group">
        ...
        <select class="form-control" name="room" id="roomSelect">
          @foreach($rooms as $room)
            <option @if(isset($booking) && $booking->room_id == $room->id) selected @endif value="{{ $room->id }}">{{ $room->name }}</option>
          @endforeach
        </select>
      </div>
      <div class="form-group">
        ...
        <div class="input-group">
          ...
          <input class="form-control" name="departure" id="basePriceInput" autocomplete="off" type="number" required @if(isset($booking)) value="{{ $booking->basePrice }}" @else value="0" @endif" min="0">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="input-group">
          <span class="input-group-addon">%</span>
          <input class="form-control" name="departure" id="discountInput" autocomplete="off" type="number" required @if(isset($booking)) value="{{ $booking->discount }}" @else value="0" @endif" min="0" max="100">
        </div>
      </div>
      <div class="form-group">
        ...
        <div class="input-group">
          <span class="input-group-addon">€</span>
          <input class="form-control" name="departure" id="depositInput" autocomplete="off" type="number" required @if(isset($booking)) value="{{ $booking->deposit }}" @else value="0" @endif" min="0">
        </div>
      </div>
      <div class="form-group">
        <label class="form-check-label">
          <input class="form-check-input" type="checkbox" value="white" @if(isset($booking) && !$booking->white) checked @endif>
          Is yes?
        </label>
      </div>
    </div>
  ...
  <div class="row justify-content-md-center">
    <div class="col-12">
      <div class="form-group">
        ...
        <textarea class="form-control" id="commentTextArea" rows="5">@if(isset($booking)) {{ $booking->comments }} @endif</textarea>
      </div>
    </div>
  </div>
    @if(isset($booking))
